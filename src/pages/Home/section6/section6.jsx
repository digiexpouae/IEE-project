      ...
      <div className="max-w-7xl flex flex-col items-center justify-center mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-[80%] mt-12">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden relative">
            ...
            <span className=" absolute left-4 right-0 top-44 w-1/3 xl:w-1/4  bg-[#0A5B21] text-white text-xs px-2 py-1 rounded">EDUCATION</span>

            <div className=" py-2 mb-6 px-5">
              <h3 className="mt-3 font-medium  text-left text-xl" style={{whiteSpace:'nowrap'}}>Education of needy orphans</h3>
