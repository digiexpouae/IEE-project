      ...
      <div className="max-w-7xl flex flex-col items-center justify-center mx-auto px-6 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-[80%] mt-12">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-5">
              <span className="bg-green-600 text-white text-xs px-3 py-1 rounded">EDUCATION</span>
              <h3 className="mt-3 font-semibold text-lg">Education of needy orphans</h3>
              <p className="text-gray-600 mt-1 text-sm">Raised: $2,140</p>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-5">
              <span className="bg-green-600 text-white text-xs px-3 py-1 rounded">EDUCATION</span>
              <h3 className="mt-3 font-semibold text-lg">Providing drinking water</h3>
              <p className="text-gray-600 mt-1 text-sm">Raised: $1,260</p>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-5">
              <span className="bg-green-600 text-white text-xs px-3 py-1 rounded">EDUCATION</span>
              <h3 className="mt-3 font-semibold text-lg">Education of needy orphans</h3>
              <p className="text-gray-600 mt-1 text-sm">Raised: $3,100</p>
              <div className="mt-2 w-full bg-gray-200  flex rounded-full h-2">
              <div className="bg-[#0A5B21] h-2 rounded-l-full w-[70%]"></div>
                <div className="bg-[#DBAC42] h-2 rounded-r-full w-[30%]"></div>
